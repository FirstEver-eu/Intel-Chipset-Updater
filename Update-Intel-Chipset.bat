...
echo ** --------------------------------------------------------------------- **
echo **                                                                       **
echo **                   Drivers Version: 10.1.x.x (LATEST)                  **
echo **                                                                       **
...
if not exist "!SCRIPT_DIR!Update-Intel-Chipset.ps1" (
    echo Error: Update-Intel-Chipset.ps1 not found in current directory!
    echo.
...
powershell -ExecutionPolicy Bypass -File "Update-Intel-Chipset.ps1"
